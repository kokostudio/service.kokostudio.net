<?php
  ...
  $user_approve = getUserApprove($_SESSION['user_code']);

  if(!isset($_SESSION['user_code']) || (($user_level != 1 && $user_approve != 1)|| empty($user_level))){
              ...
              <div class="card-body">
                <form action="?act=update" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="form-group row">
					...
					<?php if($row['req_status'] == 6 /*|| $row['req_status'] == 2 || $row['req_status'] == 3*/): ?>
                    <div class="col-sm-3 pb-2">
                      <button class="btn btn-success btn-sm btn-block" type="button" data-toggle="modal" data-target="#addManage">
                        <i class="fas fa-check pr-2"></i>ดำเนินการอนุมัติ
                      </button>
                    </div>
                    <?php
                      endif;
                  ...
                  <?php
                    $stmt = getQueryManageApprove($row['req_id']);
                  ...
                  <div class="form-group row justify-content-center">
                    ...
                    <?php endif; ?>
                    <div class="col-sm-3 pb-2">
                      <a class="btn btn-danger btn-sm btn-block" href="approve.php">
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title">เพิ่มดำเนินการอนุมัติ</h5>
              </div>
              <?php
                @$req_id = $_GET['id'];
                $stmt = getQueryRequest($req_id);
              ...
              <div class="modal-body">
                <form action="?act=insert" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="form-group row">
                    <label class="col-sm-4 col-form-label text-md-right">วันที่อนุมัติ</label>
                    <div class="col-sm-6">
			      ...
			      <div class="form-group row">
                    <label class="col-sm-4 col-form-label text-md-right">ผู้ดำเนินการอนุมติ</label>
                    <div class="col-sm-6">
                  ...
                  <div class="form-group row justify-content-center">
                    <div class="col-sm-5 mb-2">
                      <button class="btn btn-success btn-sm btn-block" name="btnInsert">
                        <i class="fa fa-check mr-2"></i>อนุมัติ
                      </button>
                    </div>
                    <div class="col-sm-5 mb-2">
