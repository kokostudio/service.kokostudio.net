...
--
-- Host: localhost
-- Generation Time: Dec 26, 2018 at 05:49 AM
...
(1, 'สาขา 1', 'xxxxxxxxxxxxxxxxxxx', 1, '2018-12-22 12:14:32', '2018-12-22 08:19:13');
...
(8, 2, 0, 'Browser Chrome, Internet Explorer เปิดไม่ขึ้น ค้าง', 1, '2018-11-22 15:24:47', '2018-11-30 02:13:40'),
...
(1, 'e-Service', 'e-Service Notification', 'eservice@gmail.com', '123456', 'xxxxxxxxxxxxxxxxxxxxx', '123456', '999999', '2018-11-23 14:24:14', '2018-12-21 08:18:31');
...
INSERT INTO `ex_user` (`user_id`, `user_code`, `user_name`, `user_surname`, `user_picture`, `user_nickname`, `dep_id`, `bra_id`, `user_branch`, `user_email`, `user_telephone`, `user_mobile`, `user_line`, `user_level`, `user_status`, `user_create`, `user_update`) VALUES
(1, '111111', 'User', 'test', '111111.jpg', 'User', 1, 2, '', 'user@klangplaza.com', '', '', '', 1, 1, '2018-11-19 11:08:08', '2018-12-22 09:02:49'),
(2, '999999', 'Administrator', 'System', '999999.jpg', 'Administrator', 1, 2, '', 'it@klangplaza.com', '1704', '1704', '', 99, 1, '2018-11-19 11:35:15', '2018-12-22 09:01:12'),
(3, '777777', 'Manage', 'test', '777777.jpg', 'Manage', 1, 2, '', 'manage@klangplaza.com', '', '', '', 69, 1, '2018-11-22 08:05:48', '2018-12-22 09:02:36');
...
--
ALTER TABLE `ex_branch`
  MODIFY `bra_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `ex_manage`
  MODIFY `manage_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
